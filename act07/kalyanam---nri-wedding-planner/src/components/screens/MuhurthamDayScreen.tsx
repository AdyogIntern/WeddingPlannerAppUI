    ...
    <div className="min-h-full bg-[#FAF7F2] text-[#1F1A17] flex flex-col pb-8">
      ...
      <div className="px-5 pt-3 sticky bottom-0 bg-[#FAF7F2] border-t border-[#E8E0D5]/50 pb-2 space-y-2">
        {onOpenGuests && (
          ...
          >
            <span>Proceed to Step 4: Guests & Ops Management</span>
            <span>→</span>
          </button>
        )}
        <button 
          onClick={handleCall}
          className="w-full py-2.5 px-4 bg-white text-[#7A2232] border border-[#7A2232]/40 font-medium text-[13px] rounded-xl hover:bg-[#FAF0EC] active:scale-[0.99] transition-all flex items-center justify-center gap-2"
        >

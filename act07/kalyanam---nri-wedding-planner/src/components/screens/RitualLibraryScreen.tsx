        ...
        <div className="p-4 bg-[#F5ECE5] rounded-2xl text-[12.5px] leading-relaxed text-[#5A5046] flex flex-col gap-2.5">
          ...
          {onViewRunsheet && (
            <button
              ...
              className="mt-1 py-3 px-4 bg-[#7A2232] text-white font-bold text-[13px] rounded-xl hover:bg-[#5A1924] active:scale-[0.99] transition-all text-center shadow-xs flex items-center justify-center gap-2"
            >
              <span>Proceed to Step 3: Muhurtham Day Runsheet</span>
              <span>→</span>
            </button>
          )}
        </div>
